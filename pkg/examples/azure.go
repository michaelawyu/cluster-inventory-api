...
import (
	...
	"sigs.k8s.io/cluster-inventory-api/pkg/credentials/overriders"
)
	...
	providers := []credentials.Provider{
		{
			...
			ExecConfigOverrider: &overriders.AzureKubeLoginExecConfigOverrider{},
		},
	}
			...
			CredentialProviders: []v1alpha1.CredentialProvider{
				{
					...
					Cluster: clientcmdapiv1.Cluster{
						...
						Extensions: []clientcmdapiv1.NamedExtension{
							{
								Name: "multicluster.x-k8s.io/clusterprofiles/auth/exec/kubelogin-additional-args",
